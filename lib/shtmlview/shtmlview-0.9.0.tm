#* shtmlview-0.9.0.tm HTML-Viewer
...
package provide shtmlview::shmtlview 0.9.0
...
if {[info exists argv0] && [info script] eq $argv0} {
    ...
    if {[llength $argv] > 0} {
        if {[lindex $argv 0] eq "test"} {
            ...
            $help browse /home/dgroth/workspace/goblet/dgHelpBrowser.vfs/html/tablelist/index.html
            .help2 browse /home/dgroth/workspace/goblet/dgHelpBrowser.vfs/html/bwidget/contents.html
            pack .help2 -fill both -expand true -side left
